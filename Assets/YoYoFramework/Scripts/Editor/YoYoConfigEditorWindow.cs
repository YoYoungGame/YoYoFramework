...
namespace YoYo.Editor
{
    public class YoYoConfigEditorWindow : EditorWindow
    {
        ...
        private string configPath = "StreamingAssets/Config";
        ...
        private void OnGUI()
        {
            ...
            EditorGUILayout.LabelField("Config Path:", GUILayout.Width(80));
        ...
        {
            if (selectedConfigType == null) return;

            string fullPath = Path.Combine(Application.dataPath, configPath, selectedConfigType.Name + ".json");
        ...
        {
            if (currentConfig == null || selectedConfigType == null) return;

            string fullDir = Path.Combine(Application.dataPath, "StreamingAssets", "Config");

            if (!Directory.Exists(fullDir))
                Directory.CreateDirectory(fullDir);

            string fullPath = Path.Combine(fullDir, selectedConfigType.Name + ".json");
